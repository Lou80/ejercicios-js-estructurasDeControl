...
Escribir un programa donde se ingresa un número entre 1 y 7 que representa un día de la semana y se obtiene un mensaje como salida.
En caso de ingresar un número que no sea válido mostrar un mensaje de error.

Declarar la variable dia y asignar un número del 1 al 7

Declarar la variable nombreDelDia y asignar un valor null*/

var dia = prompt('Ingrese un número del 1 al 7');
parseInt(dia);
var nombreDelDia = null;

/*Versión SWITCH
Según el día seleccionado Entonces asignar el nombre del día correspondiente al número en la variable nombreDelDia 
